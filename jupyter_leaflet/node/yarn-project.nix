...
let
  ...
  yarnBin = fetchurl {
    ...
    hash = "sha512-2b5nxc48mpaQcG3nLehsmyPaZ7HpFCmtD4G6bUp0kt4KuULbE/vBWNjBtUl1kzPAQBY9V6GRTmQNpGpkZ2fqEA==";
  };
  ...
  cacheDrv = stdenv.mkDerivation {
    ...
    outputHash = "sha512-gVJWr91hHd58YBTaWN4Yt0lvVZ1w8x6EfFehda38g7I+EGuFJRXqYhYnuzBBo3X/aUywIec3TzJucURd5AY24w==";
  };
